...
struct Z_Construct_UScriptStruct_FPartsInfo_Statics
{
	...
	static constexpr UECodeGen_Private::FMetaDataPairParam NewProp_PartsNamePattern_MetaData[] = {
		{ "Category", "Parts Name Pattern" },
		{ "ModuleRelativePath", "DataAsset/DTFDataAsset.h" },
	};
	static constexpr UECodeGen_Private::FMetaDataPairParam NewProp_PartsOffsetTransform_MetaData[] = {
	...
	static const UECodeGen_Private::FStructPropertyParams NewProp_PartsOffsetTransform;
...
const UECodeGen_Private::FNamePropertyParams Z_Construct_UScriptStruct_FPartsInfo_Statics::NewProp_PartsName = { "PartsName", nullptr, (EPropertyFlags)0x0010000000000015, UECodeGen_Private::EPropertyGenFlags::Name, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FPartsInfo, PartsName), METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_PartsName_MetaData), NewProp_PartsName_MetaData) };
...
const UECodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FPartsInfo_Statics::NewProp_PartsOffsetTransform = { "PartsOffsetTransform", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FPartsInfo, PartsOffsetTransform), Z_Construct_UScriptStruct_FTransform, METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_PartsOffsetTransform_MetaData), NewProp_PartsOffsetTransform_MetaData) };
...
const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UScriptStruct_FPartsInfo_Statics::PropPointers[] = {
	...
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UScriptStruct_FPartsInfo_Statics::NewProp_PartsOffsetTransform,
...
struct Z_Construct_UClass_UDTFDataAsset_Statics
{
	...
	static constexpr UECodeGen_Private::FMetaDataPairParam NewProp_PartsActorClass_MetaData[] = {
		{ "Category", "Parts SoftObejct Info" },
		{ "ModuleRelativePath", "DataAsset/DTFDataAsset.h" },
	};
#endif // WITH_METADATA
	...
	static const UECodeGen_Private::FSoftClassPropertyParams NewProp_PartsActorClass;
	static const UECodeGen_Private::FPropertyParamsBase* const PropPointers[];
...
const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UClass_UDTFDataAsset_Statics::PropPointers[] = {
	...
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_UDTFDataAsset_Statics::NewProp_PartsActorClass,
};
...
// ********** Begin Registration *******************************************************************
struct Z_CompiledInDeferFile_FID_Users_BCA_PC20_Desktop_DT_ProjectFinal_DT_ProjectFinal_Source_DT_ProjectFinal_DataAsset_DTFDataAsset_h__Script_DT_ProjectFinal_Statics
{
...
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Users_BCA_PC20_Desktop_DT_ProjectFinal_DT_ProjectFinal_Source_DT_ProjectFinal_DataAsset_DTFDataAsset_h__Script_DT_ProjectFinal_1617594273(TEXT("/Script/DT_ProjectFinal"),
	Z_CompiledInDeferFile_FID_Users_BCA_PC20_Desktop_DT_ProjectFinal_DT_ProjectFinal_Source_DT_ProjectFinal_DataAsset_DTFDataAsset_h__Script_DT_ProjectFinal_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Users_BCA_PC20_Desktop_DT_ProjectFinal_DT_ProjectFinal_Source_DT_ProjectFinal_DataAsset_DTFDataAsset_h__Script_DT_ProjectFinal_Statics::ClassInfo),
	Z_CompiledInDeferFile_FID_Users_BCA_PC20_Desktop_DT_ProjectFinal_DT_ProjectFinal_Source_DT_ProjectFinal_DataAsset_DTFDataAsset_h__Script_DT_ProjectFinal_Statics::ScriptStructInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Users_BCA_PC20_Desktop_DT_ProjectFinal_DT_ProjectFinal_Source_DT_ProjectFinal_DataAsset_DTFDataAsset_h__Script_DT_ProjectFinal_Statics::ScriptStructInfo),
	nullptr, 0);
// ********** End Registration *********************************************************************
